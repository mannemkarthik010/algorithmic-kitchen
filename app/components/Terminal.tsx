...
const CMD: Record<string, () => Line[]> = {
  ...
  "open resume": () => [
    ...
    { text: `  M.S. GPA   : 3.9 / 4.0 — CSUN`, type: "output" },
  ...
  "why hire karthik": () => [
    ...
    { text: "  1,000+ LLM outputs graded at Handshake AI — eval expertise.", type: "output" },
    { text: "  Docker + Flask + AWS: ships real systems, not demos.", type: "output" },
    { text: "  3.9 GPA M.S. CS — rigorous academic foundation.", type: "output" },
    { text: "", type: "output" },
